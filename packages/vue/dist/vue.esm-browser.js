...
export { Comment, Fragment, PublicPatchFlags as PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize, cloneVNode, compileToFunction as compile, computed$1 as computed, exportedCreateApp as createApp, createBlock, createComponent, createRenderer, createSlots, createVNode, effect, getCurrentInstance, h, handleError, inject, instanceWatch, isReactive, isReadonly, isRef, markNonReactive, markReadonly, mergeProps, nextTick, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, provide, reactive, readonly, recordEffect, ref, registerRuntimeCompiler, render, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, toHandlers, toRaw, toRefs, toString, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, version, warn, watch, withDirectives, withKeys, withModifiers };
