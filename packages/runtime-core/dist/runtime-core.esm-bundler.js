...
export { Comment, Fragment, PublicPatchFlags as PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, applyDirectives, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize, cloneVNode, computed, createBlock, createComponent, createRenderer, createSlots, createVNode, getCurrentInstance, h, handleError, inject, instanceWatch, mergeProps, nextTick, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, provide, recordEffect, registerRuntimeCompiler, renderList, renderSlot, resolveComponent, resolveDirective, toHandlers, toString, warn, watch };
