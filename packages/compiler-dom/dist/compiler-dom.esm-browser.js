...
export { advancePositionWithClone, advancePositionWithMutation, assert, baseCompile, compile, createArrayExpression, createBlockExpression, createCacheExpression, createCallExpression, createCompilerError, createCompoundExpression, createConditionalExpression, createFunctionExpression, createInterpolation, createObjectExpression, createObjectProperty, createSequenceExpression, createSimpleExpression, createStructuralDirectiveTransform, findDir, findProp, generate, generateCodeFrame, getInnerRange, hasScopeRef, injectProp, isEmptyExpression, isHTMLTag, isMemberExpression, isSVGTag, isSimpleIdentifier, isSlotOutlet, isTemplateNode, isVSlot, isVoidTag, loadDep, locStub, parse, parseJS, registerRuntimeHelpers, toValidAssetId, transform, transformModel, transformOn, walkJS };
