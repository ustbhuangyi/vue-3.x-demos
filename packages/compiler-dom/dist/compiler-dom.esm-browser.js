...
export { advancePositionWithClone, advancePositionWithMutation, assert, baseCompile, compile, createArrayExpression, createBlockExpression, createCallExpression, createCompilerError, createCompoundExpression, createConditionalExpression, createFunctionExpression, createInterpolation, createObjectExpression, createObjectProperty, createSequenceExpression, createSimpleExpression, createStructuralDirectiveTransform, findDir, findProp, generate, getInnerRange, injectProp, isEmptyExpression, isMemberExpression, isSimpleIdentifier, isSlotOutlet, isTemplateNode, isVSlot, loadDep, locStub, parse, parseJS, registerRuntimeHelpers, toValidAssetId, transform, transformModel, transformOn, walkJS };
